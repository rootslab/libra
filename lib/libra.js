...
exports.Libra = ( function () {
    ...
    lproto.push = function ( ocmd ) {
        ...
        if ( m.on ) {
            // a MONITOR command was previously queued, don't write other commands to socket.
            return ocmd.isQuit ?
        ...
        if ( t.on ) {
            ...
            if ( ocmd.isSubscription ) {
                ...
                return sendError( ocmd, 'PubSub commands are not allowed inside transactions.' );
            }
