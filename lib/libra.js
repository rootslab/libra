...
exports.Libra = ( function () {
    ...
    lproto.push = function ( ocmd ) {
        ...
        if ( t.on ) {
            ...
            if ( ocmd.isSubscription || ocmd.isUnsubscription ) {
        ...
        if ( s.on ) {
             ...
             * subscriptions commands are allowed, and QUIT.
             */
            if ( ! ocmd.isSubscription && ! ocmd.isQuit ) {
        ...
        if ( ocmd.isMonitor ) m.on = 1;
             ...
             * Pubsub mode produces messages, then if PubSub mode is not active,
             * discard the command with an error.
